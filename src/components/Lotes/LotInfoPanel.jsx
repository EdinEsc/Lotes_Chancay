...
const LotInfoPanel = ({ showLotInfo, setShowLotInfo, selectedLot, mapConfig }) => {
  if (!showLotInfo || !selectedLot) return null;
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* REMOVIDO: Indicadores de lote más grande y lotes grandes */}
        {/* Estos ya no existen en la nueva versión */}
      </h3>
      ...
      {selectedLot.features && selectedLot.features.length > 0 && (
        <div className="mb-6">
          <div className="flex items-center gap-2 font-bold mb-3 text-[15px] text-gray-700">
            <Check size={18} className="text-[#cb4a2a]" />
            Características:
          </div>
